...
(function($) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        $('.section').each(function(index){
            ...
            if(options.scrollOverflow){
                if(container.hasClass('fullpage-used')){
                    createNiceScrollingHandler();
                }
                //after DOM and images are loaded
                $(window).on('load', createNiceScrollingHandler);
            }else{
        ...
        function createNiceScrollingHandler(){
            $('.section').each(function(){
                var slides = $(this).find('.slide');

                if(slides.length){
                    slides.each(function(){
                        createNiceScrolling($(this));
                    });
                }else{
                    createNiceScrolling($(this));
                }
        ...
        */
        ...
        function MouseWheelHandler(e) {
            if(options.autoScrolling){
                ...
                var delta = Math.max(-1, Math.min(1,
                        (e.wheelDelta || -e.deltaY || -e.detail || -e.end.y)));
                var scrollable;
                var activeSection = $('.section.active');
        ...
        if(options.normalScrollElements){
            $(document)
                .on('mouseover', options.normalScrollElements, function () {
                    $.fn.fullpage.setMouseWheelScrolling(false);
                });
        ...
        */
        function isScrolled(type, scrollable){
            var niceScroll = scrollable.getNiceScroll()[0];
            //console.log(niceScroll.page.maxh, niceScroll.getScrollTop());
            if(type === 'top'){
                return !niceScroll.getScrollTop();
            }else if(type === 'bottom'){
                return niceScroll.getScrollTop() >= niceScroll.page.maxh;
            }
        }
        ...
        */
        ...
        function createNiceScrolling(element){
            ...
            if ( contentHeight > scrollHeight) {
                ...
                //creating the scrolling
                    ...
                    console.log(element);
                    element.find('.scrollable').niceScroll().hide();
                }
            } else{
                removeNiceScroll(element);
            }
        ...
        function removeNiceScroll(element){
            if (element.find('.scrollable').length) {
                var $scrollable = element.find('.scrollable');
